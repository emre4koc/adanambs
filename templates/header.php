...
// Pasif kullanıcı kontrolü - Sidebar için gerekli
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-auto p-6">
                ...
                if (isset($_SESSION['mesaj'])) {
                    ...
                    $bg_color = $mesaj['tip'] == 'success' ? 'bg-green-100 border-green-400 text-green-700' : 
                                ($mesaj['tip'] == 'warning' ? 'bg-yellow-100 border-yellow-400 text-yellow-700' : 
                                'bg-red-100 border-red-400 text-red-700');
                    echo '<div class="' . $bg_color . ' border-l-4 p-4 mb-4">
                        <p>' . htmlspecialchars($mesaj['icerik']) . '</p>
                    </div>';
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-yellow-700">
                                    <strong>Hesabınız pasif durumdadır.</strong> Sadece görevlerinizi ve profilinizi görüntüleyebilirsiniz.
                                </p>
                            </div>
                        </div>
                    </div>';
