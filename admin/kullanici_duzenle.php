...
if (isset($_POST['bilgi_guncelle'])) {
    ...
    elseif (!empty($tc_no) && strlen($tc_no) != 11) {
        $mesaj = ['tip' => 'error', 'icerik' => 'T.C. Kimlik Numarası 11 hane olmalıdır.'];
    } else {
        $sql = "UPDATE users SET ad=?, soyad=?, email=?, rol=?, klasman=?, telefon=?, lisans_no=?, dogum_tarihi=?, aktif=?, tc_no=?, banka_bilgisi=?, iban=?, dogum_yeri=?, kan_grubu=?, il=?, ilce=?";
        $params = [$ad, $soyad, $email, $rol, $klasman, $telefon, $lisans_no, $dogum_tarihi, $aktif, $tc_no, $banka_bilgisi, $iban, $dogum_yeri, $kan_grubu, $il, $ilce];
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <form method="POST">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block text-gray-700 text-sm font-medium">T.C. Kimlik Numarası</label>
                            <input type="text" name="tc_no" value="<?php echo htmlspecialchars($kullanici->tc_no); ?>" class="w-full mt-1 p-2 border rounded" maxlength="11">
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium">Banka Bilgisi</label>
                            <input type="text" name="banka_bilgisi" value="<?php echo htmlspecialchars($kullanici->banka_bilgisi); ?>" class="w-full mt-1 p-2 border rounded">
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium">IBAN</label>
                            <input type="text" name="iban" value="<?php echo htmlspecialchars($kullanici->iban); ?>" class="w-full mt-1 p-2 border rounded">
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium">Doğum Yeri</label>
                            <input type="text" name="dogum_yeri" value="<?php echo htmlspecialchars($kullanici->dogum_yeri); ?>" class="w-full mt-1 p-2 border rounded">
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium">Kan Grubu</label>
                            <input type="text" name="kan_grubu" value="<?php echo htmlspecialchars($kullanici->kan_grubu); ?>" class="w-full mt-1 p-2 border rounded">
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium">İl</label>
                            <input type="text" name="il" value="<?php echo htmlspecialchars($kullanici->il); ?>" class="w-full mt-1 p-2 border rounded">
                        </div>
                        <div>
                            <label class="block text-gray-700 text-sm font-medium">İlçe</label>
                            <input type="text" name="ilce" value="<?php echo htmlspecialchars($kullanici->ilce); ?>" class="w-full mt-1 p-2 border rounded">
                        </div>
                        <div>
